...
public class TrafficAutomaticFormController {
    ...
    public int uploadTrafficDataBase(){
        ...
        String JsonString = TrafficUploader.getInstance().generateJsonIncident(getTrafficType(20,50),"Traffic Test",dateCreated, deathDate , GeometryType.LINE_STRING.getName(),coordinates);
